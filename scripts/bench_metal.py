...
CONFIGS = [
    # Softmax — small batches
    ("softmax", "f32", "[1, 1024]",    1),
    ("softmax", "f32", "[1, 4096]",    1),
    ("softmax", "f32", "[16, 1024]",   16),
    ("softmax", "f32", "[16, 4096]",   16),
    ("softmax", "f32", "[64, 1024]",   64),
    ("softmax", "f32", "[64, 4096]",   64),
    ("softmax", "f32", "[256, 1024]",  256),
    ("softmax", "f32", "[256, 4096]",  256),
    ("softmax", "f32", "[1024, 1024]", 1024),
    ("softmax", "f32", "[1024, 4096]", 1024),
    ("softmax", "f32", "[4096, 1024]", 4096),
    ("softmax", "f32", "[4096, 4096]", 4096),
    # LayerNorm
    ("layernorm", "f32", "[1, 1024]",    1),
    ("layernorm", "f32", "[1, 4096]",    1),
    ("layernorm", "f32", "[16, 1024]",   16),
    ("layernorm", "f32", "[16, 4096]",   16),
    ("layernorm", "f32", "[64, 1024]",   64),
    ("layernorm", "f32", "[64, 4096]",   64),
    ("layernorm", "f32", "[256, 1024]",  256),
    ("layernorm", "f32", "[256, 4096]",  256),
    ("layernorm", "f32", "[1024, 1024]", 1024),
    ("layernorm", "f32", "[1024, 4096]", 1024),
    ("layernorm", "f32", "[4096, 1024]", 4096),
    ("layernorm", "f32", "[4096, 4096]", 4096),
    # Dilated Conv1D + ReLU
    ("conv1d-dilated", "f32", "[1, 1024]",    1),
    ("conv1d-dilated", "f32", "[1, 4096]",    1),
    ("conv1d-dilated", "f32", "[16, 1024]",   16),
    ("conv1d-dilated", "f32", "[16, 4096]",   16),
    ("conv1d-dilated", "f32", "[64, 1024]",   64),
    ("conv1d-dilated", "f32", "[64, 4096]",   64),
    ("conv1d-dilated", "f32", "[256, 1024]",  256),
    ("conv1d-dilated", "f32", "[256, 4096]",  256),
    ("conv1d-dilated", "f32", "[1024, 1024]", 1024),
    ("conv1d-dilated", "f32", "[1024, 4096]", 1024),
    ("conv1d-dilated", "f32", "[4096, 1024]", 4096),
    ("conv1d-dilated", "f32", "[4096, 4096]", 4096),
]
